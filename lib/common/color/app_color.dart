...
class AppColors {
  ...
  static const disabled = Color(0xB6F0F0F0);
  ...
  static const orange = Color(0xCCF57B55);
  static const boldOrange = Color(0xCCFC5017);
  static const info = Color(0xff0288d1);
  static const neutral = Color(0xff232735);
  static const transparent = Color(0x00000000);
  static const backgroundColor = Color(0xFFFAF7F7);
